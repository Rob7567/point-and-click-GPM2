...
{
    public static SC_ItemCrafting ItemCrafting;
    ...
    SlotContainer[] craftSlots = new SlotContainer[2];
    SlotContainer resultSlot = new SlotContainer();
    //Lis of all available items
    public Item[] items;
    ...
    public void PickupItem()
    {
        ...
        for(int i = 0; i < playerSlots.Length; i++)
        {
            ...
            {
                playerSlots[i].itemSprite = currentSprite;
    ...
    public void RätselCheck()
    {
        for (int i = 0; i < playerSlots.Length; i++)
        {
            if(playerSlots[i].itemSprite == rätselSprite)
            {
                rätselBool = true;
